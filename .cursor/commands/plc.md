...
> Activate plc-specialist for PLC programming, HMI design, safety PLC configuration, and industrial communication.
...
1. Read the agent's full instructions from `.windsurf/agents/plc-specialist.md` (or `.cursor/rules/agents/plc-specialist.mdc`)
