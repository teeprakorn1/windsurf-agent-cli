...
> Multi-agent protocol coordination for end-to-end API lifecycle. Orchestrates protocol-architect, backend, frontend, security, and devops for API design, migration, governance, and MCP ecosystem building.
