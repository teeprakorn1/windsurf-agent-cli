...
> Activate chief-machine-engineer for machine design leadership, multi-discipline coordination, and project technical authority.
...
1. Read the agent's full instructions from `.windsurf/agents/chief-machine-engineer.md` (or `.cursor/rules/agents/chief-machine-engineer.mdc`)
