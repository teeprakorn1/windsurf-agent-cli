...
python3 .windsurf/scripts/verify_all.py . --url http://localhost:3000
...
python3 .windsurf/skills/performance-profiling/scripts/lighthouse_audit.py http://localhost:3000

# P4: Playwright E2E (requires running server)
python3 .windsurf/skills/webapp-testing/scripts/playwright_runner.py http://localhost:3000 --screenshot
```
