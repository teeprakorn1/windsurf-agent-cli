---
description: Security incident response — breach detection, containment, forensics, recovery, and post-mortem. Used when investigating suspected compromise or data breach.
---
