#!/usr/bin/env python3
"""
Session Manager - Aiyu Agent Kit
=================================
Analyzes project state, detects tech stack, tracks file statistics, and provides
a summary of the current session.

Usage:
    python3 .windsurf/scripts/session_manager.py status [path]
    python3 .windsurf/scripts/session_manager.py info [path]
"""
...
def count_files(root: Path) -> Dict[str, int]:
    ...
    exclude = {".git", "node_modules", ".next", "dist", "build", ".windsurf", ".gemini", "__pycache__"}
