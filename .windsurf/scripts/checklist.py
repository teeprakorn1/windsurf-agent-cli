#!/usr/bin/env python3
"""
Master Checklist Runner - Aiyu Agent Kit
==========================================
...
CORE_CHECKS = [
    ...
    ("Test Runner", ".windsurf/skills/testing-patterns/scripts/test_runner.py", False),
...
def main():
    parser = argparse.ArgumentParser(
        description="Run Aiyu Agent Kit validation checklist",
...
Examples:
  ...
  python3 scripts/checklist.py . --url http://localhost:3000  # Include performance
    ...
    print_header("🚀 AIYU AGENT KIT - MASTER CHECKLIST")
